...
#if defined(__AVR_ATmega644P__) || defined(__AVR_ATmega1284P__) || defined (__AVR_ATmega16__)
/*------------------------------------------------------------------------ */
...
#if defined (__AVR_ATmega32__) && defined (_DUINO_MEGA32_)
/*------------------------------------------------------------------------ */
/* Duino Mega32	-dl							  */
/*------------------------------------------------------------------------ */
/* Onboard LED is connected to pin PD7 on Duino Mega32 */
#if !defined(LED)
#define LED         D7
#endif

/* Boot button is connected to pin PD2 */
#define BLPORT	 PORTD
#define BLDDR	 DDRD
#define BLPIN	 PD2
